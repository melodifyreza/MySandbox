...
> [!NOTE]
> بخاطر محدودیت‌ `MB_100` از سمت گیت‌هاب، ما ماکسیمم حجم مجاز برای هر فایل را پیش‌فرض `95_MB` قرار دادیم، در صورت بالاتر بودن حجم فایل از این مقدار؛ تکه تکه و فشرده (zip) خواهد شد.
>
> <br>
>
> <br/>
...
> [!WARNING]
> **نکته:** دقت کنید همچنان می‌تونید مثل گذشته از پیام گذاشتن داخل کامیت ها استفاده کنید جهت دانلود.  
> برای اینکار بجای download: link باید dl: link بنویسید،
>
> 
